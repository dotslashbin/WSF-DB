CREATE TABLE [dbo].[LocationLocale] (
    ...
    [created]     SMALLDATETIME CONSTRAINT [DF_LocationLocale_created] DEFAULT (getdate()) NOT NULL,
    [updated]     SMALLDATETIME NULL,
    [WF_StatusID] SMALLINT      CONSTRAINT [DF_LocationLocale_WF_StatusID] DEFAULT ((0)) NOT NULL,
