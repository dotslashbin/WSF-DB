CREATE TABLE [dbo].[LocationSite] (
    ...
    [created]     SMALLDATETIME CONSTRAINT [DF_LocationSite_created] DEFAULT (getdate()) NOT NULL,
    [updated]     SMALLDATETIME NULL,
    [WF_StatusID] SMALLINT      CONSTRAINT [DF_LocationSite_WF_StatusID] DEFAULT ((0)) NOT NULL,
