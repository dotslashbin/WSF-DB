CREATE TABLE [dbo].[WineColor] (
    ...
    [created]     SMALLDATETIME CONSTRAINT [DF_WineColor_created] DEFAULT (getdate()) NOT NULL,
    [updated]     SMALLDATETIME NULL,
    [WF_StatusID] SMALLINT      CONSTRAINT [DF_WineColor_WF_StatusID] DEFAULT ((0)) NOT NULL,
