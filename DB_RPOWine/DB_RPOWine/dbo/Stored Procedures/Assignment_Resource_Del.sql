...
-- =============================================
CREATE PROCEDURE [dbo].[Assignment_Resource_Del]
	@AssignmentID int, @UserId int, 
	@ShowRes smallint = 1

/*
exec Assignment_Resource_Del @AssignmentID=2, @UserId=2
*/	
...
BEGIN TRY
	...
	delete Assignment_Resource where AssignmentID=@AssignmentID and UserId = @UserId
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Assignment_Resource_Del] TO [RP_DataAdmin]
    AS [dbo];
