...
--				by producer
-- =============================================
CREATE PROCEDURE [dbo].[Wine_SearchByProducer]
	@wProducerID int,
	@IsTWASearch bit = 1,
...
/*
exec Wine_SearchByProducer @wProducerID=2383,@IsTWASearch=1, @IsWA = 1, @IsWJ = 0, @IsOnSale = 1, @Keyword='port'
*/
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Wine_SearchByProducer] TO [RP_DataAdmin]
    AS [dbo];
