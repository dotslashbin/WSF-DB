--use erpin
CREATE proc updateJulianPrices20 as begin
--updateJulianPrices20
set noCount on
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
*/
update vForSale set errors = case when errors  is null then '' else (errors + ';     ') end +   '[E07] No Raw Price'  where price is null;
