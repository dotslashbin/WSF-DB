...
CREATE proc [zupdateJulianPrices5] as begin
 
/*
debugging at @debugging
updateJulianPrices5
...
--add in erpFields for vAlertOK not already in nameyear
 
--add in erpFields for forSale items with wineN	
select wid, wineN, vintage into #forSale from vForSaleOK  where errors is null group by wid, wineN, vintage;
...
select * into xxForSale2 from #forSale2;	--@debugging
