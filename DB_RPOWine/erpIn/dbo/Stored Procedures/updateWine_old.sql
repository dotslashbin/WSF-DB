CREATE proc [updateWine_old] as begin
/*
use erpin
...
set identity_insert erp14.dbo.wine on;
merge vWine a
	using wine b
		on a.wineN = b.wineN
when matched 
...
print 'Wine Records Changed: '+convert(char, @@rowcount)
set identity_insert erp14.dbo.wine off;
end