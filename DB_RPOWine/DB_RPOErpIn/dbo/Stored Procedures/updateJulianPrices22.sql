--use erpin
CREATE proc updateJulianPrices22 as begin
--updateJulianPrices22
set noCount on
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
/*
update erpSearchD.dbo.forSaleDetail set errors = case when errors  is null then '' else (errors + ',  ') end +   'E35. No Raw Price'  where price is null;
update erpSearchD.dbo.forSaleDetail set errors = case when errors  is null then '' else (errors + ',  ') end +   'E34. Wid but No Bottle Size'  where BottleSize is null and wid is not null;
*/
...
update vForSale set errors = case when errors  is null then '' else (errors + ';     ') end +   '[E11] Retailer Code'  where price is null;
