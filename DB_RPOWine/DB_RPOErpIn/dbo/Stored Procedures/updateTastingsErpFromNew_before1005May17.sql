...
create proc updateTastingsErpFromNew_before1005May17
as begin
	...
	when matched 
			and	(     
						...
						or _fixedIdDeleted <> 0 or _fixedIdDeleted is null
					)
				  then
		update set 
			...
			, _fixedIdDeleted = 0
	when not matched by source and (_fixedIdDeleted <> 1 or _fixedIdDeleted is null) then
		update set 
			_fixedIdDeleted = 1;			    
