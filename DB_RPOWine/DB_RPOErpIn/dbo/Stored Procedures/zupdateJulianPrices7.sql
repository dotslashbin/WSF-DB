--use erpin
CREATE proc [zupdateJulianPrices7] as begin
...
--GO
--DBCC SHRINKFILE (N'erpIn' , 10)
--GO
--DBCC SHRINKFILE (N'erpIn_log' , 10)
--GO

/*
begin try
alter fullText Index on erpSearchD.dbo.forSaleDetail disable;
alter fullText Index on erpSearchD.dbo.wine disable;
alter fullText Index on erpSearchD.dbo.wineName disable;
alter fullText Index on rpoWineDataD.dbo.wine disable;
end try begin catch end catch
--alter Index all on rpoWineDataD.dbo.wine disable;
--alter Index all on erpSearchD.dbo.wineName disable;
--alter Index all on erpSearchD.dbo.wine disable;
--alter Index all on erpSearchD.dbo.forSaleDetail disable;
*/
...
-- fill in the remaining ones from vAlertOK
...
begin try drop table nameYearRaw_old end try begin catch end catch
sp_rename nameYearRaw, nameYearRaw_old
select * into nameYearRaw from nameYearRaw2c1
...
/*
Current status
	seemingly have rewritten this so that we can patch in wineN when uniquely implied
	still have to narrow down to fforSale3 which should be about 660 smaller than fforSale2
*/
