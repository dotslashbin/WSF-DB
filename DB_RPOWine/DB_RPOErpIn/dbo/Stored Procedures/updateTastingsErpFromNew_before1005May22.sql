/*
use erpin
select * into tasting from erp..tasting
od tasting, _fixedIdDeleted
 
select count(*) from tasting
	128865
select count(*) from tastingNew
	160145
 
173701
2374
*/
CREATE proc updateTastingsErpFromNew_before1005May22
as begin
	...
	when matched 
			and	(     
						...
						or a._fixedIdDeleted <> 0 or a._fixedIdDeleted is null
					)
				  then
		update set 
