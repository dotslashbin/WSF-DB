/*
summarizeBottleLocations_dev1003Mar09 19,null
summarizeBottleLocations_dev1003Mar09 19,69797
 
select * from vPurchase where whN=20 
select bottleLocations,* from whToWine where whN=19
*/ 
CREATE proc summarizeBottleLocations_before1003Mar11 (@whN int, @wineN int) as
--ALTER proc summarizeBottleLocations_dev1003Mar09 (@whN int, @wineN int) as
begin
