CREATE proc [dbo].[work] as begin
/* 
- Favorites
- Want to Try
- In My Cellar (If the user puts bottles into the bottle tab, this is computed)
- I Have Notes (this should be automatically computed)
- Others Have Notes (again, automatically computed)
- Buy This Wine
- Sell This Wine
- Other (can mean whatever people want it to mean)


Extra bits in whToWine
...
hasRemoteSellers
hasRemoteBuyers
hasRemoteWantToSellThisWine
hasRemoteWantToBuyThisWine
wantToTry
...
CREATE proc setMyWine @whN int, @wineN int, @on bit = null, @bottleCntNeeded bit = 1, @tastingCntNeeded bit = 1
as begin
...
----------------------------------------------
setMyWineBits(wantToTry, InMyCellar, IHaveNotes, buyThisWine, sellThisWine, other)
