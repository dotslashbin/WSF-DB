...
CREATE proc [dbo].[xxxsaveUser-old](@whN int, @saveName nvarChar(50))
as begin
...
insert into savedTables..BottleLocation(saveName, bottleLocationN,whN,locationN,prevItemIndex,purchaseN,bottleCountHere,bottleCountAvailable,createDate,updateDate)
		...
		from erpCellar..BottleLocation where whN = @whN
...
insert into savedTables..Location(saveName, locationN,whN,parentLocationN,prevItemIndex,name,createDate,updateDate)
		...
		from erpCellar..Location where whN = @whN
set identity_insert savedTables..Location off
 
set identity_insert savedTables..Purchase on
insert into savedTables..Purchase(saveName, purchaseN,whN,wineN,supplierN,bottleSizeN,purchaseDate,deliveryDate,pricePerBottle,bottleCount,notes,createDate,updateDate)
	                       select @saveName,purchaseN,whN,wineN,supplierN,bottleSizeN,purchaseDate,deliveryDate,pricePerBottle,bottleCount,notes,createDate,updateDate
		from erpCellar..Purchase where whN = @whN
...
insert into savedTables..Supplier(saveName, supplierN,standardSupplierN,whN,name,notes,createDate,updateDate)
		...
		from erpCellar..Supplier where whN = @whN
...
insert into BottleLocation(whN,locationN,prevItemIndex, purchaseN,bottleCountHere,bottleCountAvailable,createDate,updateDate)
