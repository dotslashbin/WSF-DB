CREATE proc [dbo].setMW(@whN int, @wineN int, @isOfInterest bit
...
set noCount on;
            ...
            begin
                        ...
                        if not exists (select * from whToWine where whN = @whN and wineN = @wineN)
                                    ...
                                    insert into whToWine(whN, wineN,isOfInterest ) 

                                                select @whN, @wineN,@isOfInterest
else
update whToWine set isOfInterest = @isOfInterest where whN=@whN and wineN=@wineN
            end
