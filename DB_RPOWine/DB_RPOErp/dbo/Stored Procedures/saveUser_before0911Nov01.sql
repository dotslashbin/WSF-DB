...
CREATE proc [dbo].[saveUser_before0911Nov01](@whN int, @saveName nvarChar(50))
as begin
...
insert into savedTables..whToTrustedPub(saveName, whN, pubN, isDerived, createDate)
	select @saveName, whN, pubN, isDerived, createDate
...
insert into savedTables..whToTrustedTaster(saveName, whN, tasterN, isDerived, createDate)
	select @saveName, whN, tasterN, isDerived, createDate
