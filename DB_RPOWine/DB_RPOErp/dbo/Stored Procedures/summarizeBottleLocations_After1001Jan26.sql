create proc summarizeBottleLocations_After1001Jan26 (@whN int, @wineN int) as
begin
...
/*
use erp
summarizeBottleLocations_After1001Jan26 20, null
...
,b as (select wineN, litres, max(nameInSummary) nameInSummary
		...
		, sum (case when deliveryDate is null or deliveryDate <= '1900' or deliveryDate > purchaseDate then 0 else isNull(bottleCount, 0) end) remainingBottleCount
	from a
