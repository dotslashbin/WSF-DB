...
CREATE proc [dbo].restoreUser(@whN int, @saveName nvarChar(50))
as begin
...
insert into Purchase(purchaseN,whN,wineN,supplierN,bottleSizeN,purchaseDate,deliveryDate,pricePerBottle,bottleCount,bottleCountBought,notes,createDate,updateDate)
	                       select purchaseN,whN,wineN,supplierN,bottleSizeN,purchaseDate,deliveryDate,pricePerBottle,bottleCount,bottleCountBought,notes,createDate,updateDate
