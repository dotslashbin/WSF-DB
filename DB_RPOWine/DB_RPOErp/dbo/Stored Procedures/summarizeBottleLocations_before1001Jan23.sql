CREATE proc summarizeBottleLocations_before1001Jan23 (@whN int, @wineN int) as
begin
...
-----------------------------------------------------------------------------------
/*
summarizeBottleLocations_after10Jan15 20, null
...
,h as (select top 199999 wineN, litres, max(nameInSummary) nameInSummary, sum(bottleCount) bottleCount, dbo.compactLocationSummary(dbo.concatFF(convert(varchar, ii)+char(12)+path))locs 
	from g
