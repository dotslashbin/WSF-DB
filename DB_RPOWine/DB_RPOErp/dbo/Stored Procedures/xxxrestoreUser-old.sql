...
CREATE proc [dbo].[xxxrestoreUser-old](@whN int, @saveName nvarChar(50))
as begin
...
insert into erpCellar..Purchase(purchaseN,whN,wineN,supplierN,bottleSizeN,purchaseDate,deliveryDate,pricePerBottle,bottleCount,notes,createDate,updateDate)
	                       select purchaseN,whN,wineN,supplierN,bottleSizeN,purchaseDate,deliveryDate,pricePerBottle,bottleCount,notes,createDate,updateDate
