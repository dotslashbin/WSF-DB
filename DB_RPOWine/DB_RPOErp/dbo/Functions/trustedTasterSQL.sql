...
-----------------------------------------------------------------------------------------------------
CREATE function [dbo].[trustedTasterSQL](@whN int, @contains nvarchar(1000)=null, @mustAlreadyBeTrustedByMe bit = 0, @maxRows int = 100)
returns varchar(max)
begin
...
/*
declare @s varChar(max) = dbo.trustedTasterSQL(20, 'flower*', 0, 100)
