CREATE  function [dbo].wineSQL_before1003Mar26 ( 
	 @Select varChar(1000)
	,@maxRows int = 100
	,@Where varchar(max) = ''
	,@GroupBy varchar(max) = ''
...
declare @s nvarchar(max) =  dbo.wineSQL_dev1003Mar16(
	...
	--'Select wineN, vintage, cellarInfo, myIconN, fullWineName,fullWineNamePlus'     --@select
