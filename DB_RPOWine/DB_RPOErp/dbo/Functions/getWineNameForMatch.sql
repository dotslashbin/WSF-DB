/*
use erp
print dbo.getWineNameForMatch('Producer','cab','Rose','Cab bll', 'USA', null,null,null,null)
print dbo.getWineNameForMatch('Producer','cabo','Rose','Cab blend', 'USA', null,null,null,'Salem')
print dbo.getWineNameForMatch('Producer',null,'Rose','Cab blend', 'USA', null,null,null,'Salem')
*/
CREATE function [dbo].getWineNameForMatch (@producerShow nvarchar(100),@labelName nvarchar(150)='',@colorClass nvarchar(20),@variety nvarchar(100),@country nvarchar(100),@region nvarchar(100),@location nvarchar(100),@locale nvarchar(100),@site nvarchar(100))
returns varchar(max)
as begin
