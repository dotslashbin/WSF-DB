...
CREATE function [dbo].[tastingCountsInRange_after0910Oct26](@whN int = null, @wineN int = null, @pubGN int,  @MustHaveReviewInThisPubG bit = 0, @mustBeTrustedTaster bit = 0)
