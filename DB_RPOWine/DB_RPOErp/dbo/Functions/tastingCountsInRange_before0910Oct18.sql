Create function [dbo].[tastingCountsInRange_before0910Oct18](@whN int = null, @wineN int = null, @pubGN int,  @MustHaveReviewInThisPubG bit = 0, @mustBeTrustedTaster bit = 0)
