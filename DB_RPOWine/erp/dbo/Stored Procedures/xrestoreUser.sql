...
CREATE proc [dbo].[xrestoreUser](@whN int, @saveName nvarChar(50))
as begin
...
insert into whToTrustedPub(whN, pubN, isDerived, dateCreated)
	select whN, pubN, isDerived, dateCreated
		from savedTables..whToTrustedPub where whN=@whN and saveName = @saveName

insert into whToTrustedTaster(whN, TasterN, isDerived, dateCreated)
	select whN, TasterN, isDerived, dateCreated
