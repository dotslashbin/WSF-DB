...
CREATE proc [dbo].[exampleMemBuildClrAssemblyVBMyWinesConcatFFSummarizeLocation] as begin set noCount on 
...
--in DOS window
cd C:\Users\Doug\Documents\Visual Studio 2008\Projects\SmartKeywords\SmartKeywords
c:\WINDOWS\Microsoft.NET\Framework\v2.0.50727\vbc /target:library SmartKeywordsClass.vb
 
 
--In SQL
 
alter database erp set trustworthy on
ALTER AUTHORIZATION ON database::erp to sa     -- only if necessary -- 
 
CREATE ASSEMBLY SmartKeywordsClass from 'D:\smartkeyword\\SmartKeywordsClass.dll' WITH PERMISSION_SET = UNSAFE;
Alter ASSEMBLY SmartKeywordsClass from 'D:\smartkeyword\\SmartKeywordsClass.dll' WITH PERMISSION_SET = UNSAFE;
Create function KeywordsToSQLWhereQ(@keywords nvarchar(max)) RETURNS nvarchar(max) EXTERNAL NAME  SmartKeywordsClass.SmartKeywordsClass.KeywordsToSQLWhereQ;
...
--in DOS window
cd D:\SmartKeyword
C:\WINDOWS\Microsoft.NET\Framework\v3.5\\vbc /target:library SmartKeywordsClass.vb
...
C:\WINDOWS\Microsoft.NET\Framework\v3.5\\vbc /target:library SmartKeywordsClass2.vb
c:\WINDOWS\Microsoft.NET\Framework\v2.0.50727\vbc /target:library SmartKeywordsClass.vb
...
create ASSEMBLY smartKeywordsClass2 from 'D:\SmartKeyword\smartKeywordsClass2.dll'	WITH PERMISSION_SET = UNSAFE;
...
ALTER ASSEMBLY smartKeywordsClass from 'D:\SmartKeyword\smartKeywordsClass.dll'	WITH PERMISSION_SET = UNSAFE;
ALTER ASSEMBLY smartKeywordsClass2 from 'D:\SmartKeyword\smartKeywordsClass2.dll'	WITH PERMISSION_SET = UNSAFE;
