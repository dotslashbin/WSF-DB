...
begin
	...
	truncate table erpIn..ewine
	
	alter index all on erpIn..ewine disable
	alter index ix_eWine_idN on erpIn..ewine rebuild

	insert into erpIn..ewine(
		--articleHandle,
		...
		hasProducerProfile,HasProducerWebSite,
	...
	from erpIn..erpSearchDWine;

	alter index all on erpIn..jwine rebuild;
