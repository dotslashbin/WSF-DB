...
verifyFinishImport_dev1003Mar25 20, 0
verifyFinishImport_dev1003Mar25 20, 1     ; select importStatus from wh where whN=20
finishImport 20
...
Create  proc verifyFinishImport_dev1003Mar26(@whN int, @finish bit) as
begin
