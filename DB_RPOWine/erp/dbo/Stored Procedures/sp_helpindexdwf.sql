...
CREATE procedure sp_helpindexdwf -- derived from sys.sp_helpindex
	@objname nvarchar(776)		-- the table to check for indexes
as
--create table #sp_helpindexdwf(object_name varChar(999),index_name varChar(999),  index_descripiton varchar(999), index_keys varchar(999))	--dwf
	...
	-- DISPLAY THE RESULTS
	insert into #sp_helpindexdwf (object_name, index_name,  index_descripiton, index_keys)		--dwf
	select
		'object_name' = @objname,
