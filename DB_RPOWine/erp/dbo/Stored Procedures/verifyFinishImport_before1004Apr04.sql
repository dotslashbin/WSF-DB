...
CREATE proc verifyFinishImport_before1004Apr04 (@whN int, @finish bit) as
--alter  proc verifyFinishImport_dev1004Apr03(@whN int, @finish bit) as
begin
...
zapUser 20
 ...
 use erp
verifyFinishImport_dev1004Apr03 20,0
