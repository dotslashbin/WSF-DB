--use erp
CREATE proc verifyFinishImport_before1004Apr03(@whN int, @finish bit) as
--alter  proc verifyFinishImport_dev1003Apr03(@whN int, @finish bit) as
begin
...
verifyFinishImport_dev1003Apr01 20,1
verifyFinishImport 20,1
select id, vintage, myWineName, erpWineName, wineN, rowFlag from transfer..userwines20 order by id
