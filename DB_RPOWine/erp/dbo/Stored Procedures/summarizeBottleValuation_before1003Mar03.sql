CREATE proc summarizeBottleValuation_before1003Mar03 (@whN int, @wineN int = null, @priceGN int = null) as
--ALTER proc summarizeBottleValuation_after1002Feb25 (@whN int, @wineN int = null, @priceGN int = null) as
begin
