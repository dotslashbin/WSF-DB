CREATE proc verifyFinishImport_dev1004Apr19 (@whN int, @finish bit) as
--ALTER proc verifyFinishImport_dev1004Apr07 (@whN int, @finish bit) as
begin
	...
	if @finish = 0
		...
		begin
			...
			*/
			...
			set @sql = replace(@sql, '@@', @whN)
			exec sp_executeSQL @sql, N'@autoMatched int, @failedAutoVintage int, @importStatus int', @autoMatched, @failedAutoVintage, @importStatus
...
/*
verifyFinishImport_dev1004Apr19 20,1
zapUser 20
