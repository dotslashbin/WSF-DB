CREATE proc summarizeBottleLocations_before1002Feb25 (@whN int, @wineN int) as
--alter proc summarizeBottleLocations_after1002Feb19 (@whN int, @wineN int) as
begin
...
/*
use erp
summarizeBottleLocations_after1002Feb19 22, null
summarizeBottleLocations_after1002Feb19 22, 106691
summarizeBottleLocations 22, 106691
...
select b.purchaseN, bottleLocations, wineN, deliveryDate,bottleCount, bottleCountBought,LocationN,parentLocationN,currentBottleCount,maxBottleCount,bottleCountHere,bottleCountAvailable,locationCapacity
	...
	where b.whN=22
		--and b.purchaseN=3845
   
   select whN, wineN, bottleLocations from whToWine where whN=22 and wineN=106691
