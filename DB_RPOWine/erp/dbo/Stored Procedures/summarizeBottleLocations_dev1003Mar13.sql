/*
summarizeBottleLocations_dev1003Mar13 20,null
summarizeBottleLocations_dev1003Mar13 19,69797
 
select * from vPurchase where whN=20 
select bottleLocations,* from whToWine where whN=19
*/
CREATE proc summarizeBottleLocations_dev1003Mar13 (@whN int, @wineN int) as
begin
