create proc wineForVintage_before1002Feb09 (@existingWineN int, @vintage nvarchar(5), @newWineN int output)
/*
...
declare @wineNN int, @wineNN2 int, @wineNN3 int, @jj int
exec dbo.wineForVintage 1011791402, '1900', @newWineN = @winenn output
print @wineNN
exec dbo.wineForVintage 1011791402, '1901', @newWineN = @winenn2 output
print @wineNN2
exec dbo.wineForVintage 1011791402, '1902', @newWineN = @winenn3 output
print @wineNN3
