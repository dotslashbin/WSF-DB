...
,g as (select c.wineN, c.effectiveBottles
	...
	,  isNull(isNull(e.mostRecentPriceLo, f.mostRecentPriceLoStd), pp.priceFromPurchase) pricePerBottleLo
	,  isNull(isNull(e.mostRecentPriceHi, f.mostRecentPriceHiStd), pp.priceFromPurchase) pricePerBottleHi
	from c
		join wine f
			on f.wineN = c.wineN
		left join price e
