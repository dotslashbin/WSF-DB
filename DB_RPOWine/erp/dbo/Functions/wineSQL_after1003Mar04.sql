CREATE  function [dbo].wineSQL_after1003Mar04 ( 
	 @Select varChar(1000)
	,@maxRows int = 100
	,@Where varchar(max) = ''
	,@GroupBy varchar(max) = ''
...
declare @s nvarchar(max) =  dbo.wineSQL_after1003Mar04(
	...
	--'Select vintage, fullWineName, myIconN'			--@Select2
