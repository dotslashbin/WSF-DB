CREATE function [dbo].[getProducerList_before1102Feb01] (@keywords varchar(200), @country varChar(200), @region varChar(200), @location varChar(200), @subLocation varChar(200), @detailedLocation varChar(200))
/*
use erpTiny
