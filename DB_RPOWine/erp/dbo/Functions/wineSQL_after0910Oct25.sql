CREATE  function [dbo].[wineSQL_after0910Oct25] ( 
	 @Select varChar(1000)
	,@maxRows int = 100
	,@Where varchar(max) = ''
	,@GroupBy varchar(max) = ''
...
declare @s nvarchar(max) =  dbo.[wineSQL_after0910Oct25](
	...
	,'where wineN=84619 and isNull(parkerZralyLevel,0)=0 and isErpTasting=0'					--@where
	,''								--@GroupBy,
