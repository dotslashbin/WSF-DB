...
--use erpTiny
CREATE function [dbo].[getPlaceList] (@keywords nvarChar(200), @country nvarChar(200), @region nvarChar(200), @location nvarChar(200), @subLocation nvarChar(200), @detailedLocation nvarChar(200))
/*
use erpTiny
