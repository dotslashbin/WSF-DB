CREATE function [dbo].[bottlesInLocation_before1001Jan08](@location int) 
returns @TT table(vintage varChar(4), fullName varChar(500), bottleSummary varChar(100))
as
begin
...
insert into @TT(vintage, fullName, bottleSummary)
select	
